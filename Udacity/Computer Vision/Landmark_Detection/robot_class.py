...
class robot:
    ...
    def sense(self):
        ...
        # I'm wanted to include the range in the class init but dont wanted to change the internal check  
        #function  
        measurements = []
        ...
        for i, landmark in enumerate(self.landmarks):
            ...
            # 2. adding Noise
            delta_x = delta_x + random.uniform(-self.measurement_noise, self.measurement_noise)
            delta_y = delta_y + random.uniform(-self.measurement_noise, self.measurement_noise)
            
            # 3. Check measurement_range
            if (abs(delta_x) < self.measurement_range and abs(delta_y) < self.measurement_range):
